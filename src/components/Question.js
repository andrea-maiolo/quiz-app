    ...
    return(
        <div className="singleQuestion">
            ...
            <p>Question: {props.question}</p>
                ...
                />
                <label htmlFor={props.answersArray[0]}>{props.answersArray[0]}</label>
                <br/>
                <input 
                    type="radio"
                    ...
                    onChange={props.onChange}
                />
                <label htmlFor={props.answersArray[1]}>{props.answersArray[1]}</label>
                <br />
                ...
                {props.answersArray[2] && <input 
                    ...
                    onChange={props.onChange}   
                />}
                {props.answersArray [2] && <label htmlFor={props.answersArray[2]}>{props.answersArray[2]}</label>} 
                ...
                {props.answersArray[3] && <input 
                    ...
                    onChange={props.onChange} 
                />}
                {props.answersArray [3] && <label htmlFor={props.answersArray[3]}>{props.answersArray[3]}</label> } 
